...
gnuplot -persist << EOFMarke
        ...
        stats file1 us 3 name "FILE1" nooutput
        stats file2 us 3 name "FILE2" nooutput
        stats file3 us 3 name "FILE3" nooutput
        stats file4 us 3 name "FILE4" nooutput
	...
	plot  [] [$7:$8] file1 using 3 w lp linetype 1 pointtype 1 linecolor 1 title '$LEG1',\
              ...
              FILE3_mean w l linetype 0 linecolor 3 linewidth 1 title 'Moyenne $LEG3', \
              file4 using 3 w lp linetype 1 pointtype 4 linecolor 4 title '$LEG4', \
              FILE4_mean w l linetype 0 linecolor 4 linewidth 1 title 'Moyenne $LEG4'
